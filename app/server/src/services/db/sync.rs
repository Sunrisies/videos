...
use crate::utils::{
    format_size, get_created_at, get_m3u8_duration, get_systemtime_created, get_thumbnail_path,
        ...
        if path.is_dir() {
                ...
                .filter_map(|e| e.ok())
            {
                ...
                if entry_path.is_dir() {
                    ...
                    if is_video_or_container(entry_path) {
                        ...
                        let created_at = get_created_at(entry_path);
